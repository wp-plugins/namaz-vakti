...

{
...

	{
		...
		$url = $ulke == 'TURKIYE' ? $this->server . '/PrayerTime/FillCity?itemId=%s&isState=false&isTurkey=true&itemSource=inner' : $this->server . '/PrayerTime/FillCity?itemId=%s&isState=false&isTurkey=false&itemSource=inner';
...

	{
		...
		$url = $this->server . '/PrayerTime/FillDistrict?itemId=%s';
...

			{
...

				{
...

					{
						...
						$veri[strtolower($k)] = $this->server . $v;
