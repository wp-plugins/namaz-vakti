...
Class NV_Widget extends WP_Widget
{
	...
	*/
	public function widget( $args, $instance )
	{
		...
		$ulke_adi = __($db_ulkeler['veri'][$varsayilan_ulke], 'namazvakti');
		$sehir_adi = $db_sehirler['veri'][$varsayilan_sehir];
		$ilce_adi = $db_ilceler['veri'][$varsayilan_ilce];
		
		if( $sehir_adi == $ilce_adi )
		{
			$yer =  $ulke_adi . '<br>' . $sehir_adi;
		} else {
			$yer = $sehir_adi . '<br>' . $ilce_adi;
		}
